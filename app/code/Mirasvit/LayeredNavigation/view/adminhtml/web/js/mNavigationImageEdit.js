...
define([
    ...
    $.widget('mage.mNavigationImageEdit', {
        /**
         * Button creation
         * @protected
         */
        ...
        _create: function () {
            ...
            $galleryContainer.on('addItem', function (event, data) {
                ...
                $('div.image', $($dropPlaceholder).parent()).not('.image-placeholder').remove();
                $(tmpl).data('image', data).insertBefore($dropPlaceholder);
                $('#attribute_' + id + '_file_save', $($container).parent())
            ...
            $galleryContainer.on('removeItem', function (event, image) {
                ...
                $('input[type="hidden"].__delete__', $($container).parent()).val(1);
                $('#attribute_' + id + '_file_save', $($container).parent())
                    .val('');
    ...
    return $.mage.mNavigationImageEdit;
});
