...
interface FilterNewServiceInterface
{
    /**
     ...
     * @return Select
     */
    public function createNewFilterSelect($dimensions, $entityIdsTable);
     ...
     * @return void
     */
    public function addNewToSelect($select, $storeId, $newFilter);
}